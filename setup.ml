...
(* OASIS_START *)
(* DO NOT EDIT (digest: 9d0216d286da0c9d234daf3ad7e72e1b) *)
(*
...
let setup_t =
  {
     ...
     build = OCamlbuildPlugin.build ["-use-ocamlfind"; "-use-ocamlfind"];
     test =
       [
          ("test",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$ocaml_monadic_tests", []))];
     ...
     package =
       {
          ...
          files_ab = ["lib/META.ab"];
          sections =
            [
               Executable
                 ({
                     cs_name = "ocaml_monadic";
                   ...
                   {exec_custom = false; exec_main_is = "ocaml_monadic.ml"});
               Executable
                 ({
                     cs_name = "ocaml_monadic_tests";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
     ...
     oasis_version = "0.4.5";
     oasis_digest =
       Some "\193.\194?\005m\184\139\172\2465\193\167\237\153\174";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
